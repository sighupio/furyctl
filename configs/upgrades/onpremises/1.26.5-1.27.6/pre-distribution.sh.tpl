...
# Always remove gangway, it was replaced with gangplank

$kubectlbin delete --ignore-not-found=true deployment gangway -n kube-system
$kubectlbin delete --ignore-not-found=true ingress gangway -n kube-system
$kubectlbin delete --ignore-not-found=true svc gangway-svc -n kube-system
