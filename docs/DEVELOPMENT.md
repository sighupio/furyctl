...
2. **Install all development tools**:
   ```bash
   mise install      # Installs Go 1.26.5, golangci-lint, goreleaser, awscli, and all Go-based tools
   ```
...
> **What gets installed**: `mise install` automatically installs Go 1.26.5, golangci-lint 2.12.2, goreleaser, awscli, addlicense, gofumpt, gci, goimports, formattag, ginkgo, and go-cover-treemap - everything you need for development.
...
- `mise install`: Installs ALL development tools automatically:
  - **Native tools**: Go 1.26.5, golangci-lint 2.12.2, goreleaser, awscli 2.15.17
