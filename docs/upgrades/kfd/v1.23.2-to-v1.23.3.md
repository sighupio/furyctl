# SIGHUP Distribution v1.23.2 to 1.23.3 Upgrade Guide

This guide describes the steps to follow to upgrade the SIGHUP Distribution (SKD) from v1.23.2 to v1.23.3.
...
The Auth module is a new addition to SKD, there is no previous version to upgrade from, but, you could have been using Pomerium, Dex and Gangway which were previously included in the Ingress and on-premises modules respectively.
...
🎉 **CONGRATULATIONS** you have now successfully updated all the core modules to SKD 1.23.3
