...
This guide describes the steps to follow to upgrade the SIGHUP Distribution (SD) from v1.23.3 to 1.23.4.
...
🎉 **CONGRATULATIONS** you have now successfully updated all the core modules to SD 1.23.4
