# SIGHUP Distribution v1.24.0 to 1.25.0 Upgrade Guide

This guide describes the steps to follow to upgrade the SIGHUP Distribution (SKD) from v1.24.0 to 1.25.0.
...
🎉 **CONGRATULATIONS** you have now successfully updated all the core modules to SKD 1.25.0
