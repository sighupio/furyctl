...
This guide describes the steps to follow to upgrade the SIGHUP Distribution (SKD) from v1.25.0 to 1.25.1.
...
🎉 **CONGRATULATIONS** you have now successfully updated all the core modules to SKD 1.25.1
