...
This guide describes the steps to follow to upgrade the SIGHUP Distribution (SKD) from v1.25.6 to 1.26.0.
...
🎉 **CONGRATULATIONS** you have now successfully updated all the core modules to SKD 1.26.0
