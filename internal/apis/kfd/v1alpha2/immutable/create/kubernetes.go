...
func (k *Kubernetes) prepare() error {
	...
	// Inject the immutable.yaml version data under "versions" so the generic walk renders
	// group_vars/all.yml.tpl alongside the playbooks (selection/validation stays in Go).
