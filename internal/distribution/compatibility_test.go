...
func TestEKSClusterCheckIsCompatible(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:                "should return true if distribution version is greater than 1.31.0 and less or equal than 1.31.2",
			distributionVersion: "v1.31.0",
			expected:            true,
		},
		{
			name:                "should return true if distribution version equals 1.31.2",
			distributionVersion: "v1.31.2",
			expected:            true,
		},
		{
			name:                "should return false if distribution version is greater than 1.31.2",
			distributionVersion: "v1.31.3",
			expected:            false,
		},
		{
		...
		{
			name:                "should return true if distribution version equals 1.32.1",
		...
		{
			name:                "should return true if distribution version equals 1.33.1",
		...
		{
			name:                "should return true if distribution version equals 1.33.3",
			distributionVersion: "v1.33.3",
			expected:            true,
		},
		{
			name:                "should return true if distribution version equals 1.34.0",
		...
		{
			name:                "should return true if distribution version equals 1.34.2",
		...
		{
			name:                "should return true if distribution version equals 1.35.0",
			distributionVersion: "v1.35.0",
			expected:            true,
		},
		{
			name:                "should return true if distribution version equals 1.35.1",
...
func TestKFDDistributionCheckIsCompatible(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:                "should return true if distribution version is greater than or equals 1.31.0 or less than or equals 1.31.2",
...
func TestOnPremisesCheckIsCompatible(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:                "should return true if distribution version is greater than or equals 1.31.0 and less than or equals 1.31.2",
			distributionVersion: "v1.31.1",
			expected:            true,
		},
		{
...
func TestImmutableCheckIsCompatible(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:                "should return true if distribution version is 1.34.2",
			distributionVersion: "v1.34.2",
			expected:            true,
		},
		{
		...
		{
			name:                "should return true if distribution version is 1.35.0",
			distributionVersion: "v1.35.0",
			expected:            true,
		},
		{
			name:                "should return true if distribution version is 1.35.1",
			distributionVersion: "v1.35.1",
			expected:            true,
		},
		{
