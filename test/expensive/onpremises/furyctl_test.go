...
var (
	...
	_ = Describe("furyctl & distro v1.27.6 - minimal", Ordered, Serial, CreateAndDeleteTestScenario("1.27.6", false))

	_ = Describe("furyctl & distro v1.28.0 - minimal", Ordered, Serial, CreateAndDeleteTestScenario("1.28.0", false))

	_ = Describe("furyctl & distro v1.28.1 - minimal", Ordered, Serial, CreateAndDeleteTestScenario("1.28.1", false))

	_ = Describe("furyctl & distro v1.29.0 - minimal", Ordered, Serial, CreateAndDeleteTestScenario("1.29.0", false))

	_ = Describe("furyctl & distro v1.29.1 - minimal", Ordered, Serial, CreateAndDeleteTestScenario("1.29.1", false))

	_ = Describe("furyctl & distro v1.29.0 - minimal - ephemeral", Ordered, Serial, CreateAndDeleteTestScenario("1.29.0", true))

	_ = Describe("furyctl & distro v1.29.1 - minimal - ephemeral", Ordered, Serial, CreateAndDeleteTestScenario("1.29.1", true))
	...
	_ = Describe("furyctl & distro v1.27.6 - minimal - by phase", Ordered, Serial, CreateAndDeleteByPhaseTestScenario("1.27.6", false))

	_ = Describe("furyctl & distro v1.28.0 - minimal - by phase", Ordered, Serial, CreateAndDeleteByPhaseTestScenario("1.28.0", false))

	_ = Describe("furyctl & distro v1.28.1 - minimal - by phase", Ordered, Serial, CreateAndDeleteByPhaseTestScenario("1.28.1", false))

	_ = Describe("furyctl & distro v1.29.0 - minimal - by phase", Ordered, Serial, CreateAndDeleteByPhaseTestScenario("1.29.0", false))

	_ = Describe("furyctl & distro v1.29.1 - minimal - by phase", Ordered, Serial, CreateAndDeleteByPhaseTestScenario("1.29.1", false))
)
